...
class Calculator():
    def __init__(self, queueCapacity = 5, chkTimer = 3, threshold = 10):
        ...
        self.eRssi     = {}             # key:id, value:estimation of rssi using kalman filter
        self.ts        = {}             # key:id, value:expire timestamp
        self.kalmanFactor = {}          # key:id, value:kalman factor (K, P, Q, R and estimation value)
    ...
    def add(self, id, value):
        ...
        if (id not in self.qRssi):
            ...
            self.kalmanFactor[id] = Kalman()

        self.qRssi[id].append(value)
        self.eRssi[id] = self.kalmanFactor[id].getEstimation(value)
        ...
        for id, container in self.qRssi.iteritems():
            ...
            if (len(container) == self.capacity):
                ...
                if (self.aRssi[nearest_uid] > -200):
                    return str(nearest_uid), round(self.eRssi[nearest_uid],1)
        return None, None
